...
() {
  return (
    <div className='h-3/4 w-3/4 bg-blue-500 rounded-2xl overflow-hidden grid grid-rows-3'>
        <div className=''>
            <img src={largeImage} />
        </div>
        ...
        <div className='flex flex-col justify-between'>
            <div className='mx-4 rounded p-1 flex items-center justify-around'>
            ...
            <div className='m-4 mt-0 flex flex-col text-sm'>
                ...
                <button className='rounded p-1'>Cancel Order</button>
            </div>
        </div>
    </div>
  )
