...
element.click()
# time.sleep(1)
driver.execute_script("window.open('https://atid.store');")
# time.sleep(1)
active_tabs = driver.window_handles
driver.switch_to.window(active_tabs[1])
element = driver.find_element(By.XPATH, "/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/main[1]/article[1]/div[1]/div[1]/section[3]/div[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/ul[1]/li[5]")
element_y = element.location['y']
driver.execute_script(f"window.scrollTo(0,{element_y});")
time.sleep(1)
element.click()
time.sleep(1)
driver.back()
